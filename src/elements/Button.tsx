...
const colorClasses = props =>
  Object.entries(props.theme.colors).reduce<TODO>(
  ...
  &.is-${name} {
    ...
    &.is-focused {
      ...
      color: ${color_invert};
      &:not(:active) {
        box-shadow: ${props.theme["button-focus-box-shadow-size"]} ${rgba(
      color,
      0.25
    )};
      }
...
const Button = styled.button`
  ...
  &.is-text {
    ...
    &.is-active {
      background-color: ${props =>
        darken(0.05, props.theme["button-text-hover-background-color"])};
      color: ${fromTheme("button-text-hover-color")};
    }
    &[disabled] {
      background-color: transparent;
  ...
  &.is-focused {
    ...
    &:not(:active) {
      box-shadow: ${fromTheme("button-focus-box-shadow-size")} ${fromTheme(
