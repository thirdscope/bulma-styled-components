  ...
  &:hover {
    ${/* sc-custom '.CTA' */ FileCTA} {
      background-color: ${({ theme }) =>
        darken(0.025, theme["file-cta-background-color"])};
      color: ${fromTheme("file-cta-hover-color")};
    }
    ${/* sc-custom '.Name' */ FileName} {
      border-color: ${({ theme }) =>
        darken(0.025, theme["file-name-border-color"])};
    }
  }
  &:active {
    ${/* sc-custom '.CTA' */ FileCTA} {
      background-color: ${({ theme }) =>
        darken(0.05, theme["file-cta-background-color"])};
      color: ${fromTheme("file-cta-active-color")};
    }
    ${/* sc-custom '.Name' */ FileName} {
      border-color: ${({ theme }) =>
        darken(0.05, theme["file-name-border-color"])};
    }
  }
`;
...
> = styled.div`
  ...
  &.is-boxed {
    ...
    &.has-name {
      ${/* sc-custom '.CTA' */ FileCTA} {
        border-radius: ${fromTheme("file-radius")} ${fromTheme("file-radius")} 0
          0;
      }
      ${/* sc-custom '.Name' */ FileName} {
        border-radius: 0 0 ${fromTheme("file-radius")}
          ${fromTheme("file-radius")};
        border-width: 0 1px 1px;
      }
    }
  }
